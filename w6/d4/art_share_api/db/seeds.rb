...
c1 = Comment.create(body: "Nice art!", user_id: u5.id, artwork_id: a1.id)
c1 = Comment.create(body: "Very tall!!", user_id: u4.id, artwork_id: a1.id)
c1 = Comment.create(body: "Nice Tower!", user_id: u3.id, artwork_id: a1.id)
c1 = Comment.create(body: "Seems dark", user_id: u3.id, artwork_id: a2.id)
c1 = Comment.create(body: "Nice Cave!", user_id: u5.id, artwork_id: a2.id)
c1 = Comment.create(body: "BAD ART!", user_id: u5.id, artwork_id: a3.id)
c1 = Comment.create(body: "Better than the first", user_id: u5.id, artwork_id: a4.id)
